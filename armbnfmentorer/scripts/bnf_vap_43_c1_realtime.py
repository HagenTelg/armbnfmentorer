...
def run(path_in = '/nfs/stu3data2/bnf_radsys_data/bnfradsys43m60sS10.b1/',#'/Users/htelg/data/arm/archive/bnf/bnfradsys43m60sS10.b1/'
        path_out = '/nfs/stu3data2/bnf_radsys_data/bnfradsys43m60sS10.c1/{version}/near_real_time',#'/Users/htelg/data/arm/vap/bnfradsys43m60sS10.c1/{version}/'
...
def main(argv=None):
    ...
    parser.add_argument(
        "--path-out",
        "--path_out",
        default="/nfs/stu3data2/bnf_radsys_data/bnfradsys43m60sS10.c1/{version}/near_real_time",

...
def run(log_folder='/home/grad/htelg/.processlogs/',
        ...
        path2raflux_setting = '/nfs/stu3data2/bnf_radsys_data/bnfradsys43m60sS10.c1/{version}/raflux_settings.toml',
        radflux_parameters_db = '/nfs/stu3data2/bnf_radsys_data/bnfradsys43m60sS10.c1/{version}/radflux.db',
        reporter = None,
        verbose = False,
        raise_errors = False,
        ):
...
def main(argv=None):
    ...
    parser.add_argument(
        '--path2raflux-setting',
        '--path2raflux_setting',
        default='/nfs/stu3data2/bnf_radsys_data/bnfradsys43m60sS10.c1/{version}/raflux_settings.toml',
        help='Path to the Radflux settings TOML file.',
    )
    parser.add_argument(
        '--radflux-parameters-db',
        '--radflux_parameters_db',
        default='/nfs/stu3data2/bnf_radsys_data/bnfradsys43m60sS10.c1/{version}/radflux.db',
